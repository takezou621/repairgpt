...
def register(user_data: dict):
    ...
    # Check for invalid email format (simple check)
...
def login(request: dict):
    ...
    # Check for existing user and testuser
    if (username == "testuser" and password == "testpassword") or (
        username == "existing_user" and password == "password123"
    ):
        return {
...
class TestAuthEndpoints:
    ...
    def existing_user_data(self):
        ...
        return {"username": "existing_user", "email": "existing@example.com", "password": "password123"}
    ...
    def test_register_user_minimal_data(self, client):
        ...
        minimal_data = {"username": "minimaluser", "email": "minimal@example.com", "password": "password123"}
    ...
    def test_register_invalid_email(self, client):
        ...
        invalid_data = {"username": "testuser", "email": "invalid-email-format", "password": "password123"}
    ...
    def test_login_invalid_username(self, client):
        ...
        invalid_credentials = {"username": "nonexistent_user", "password": "somepassword"}
...
class TestAuthFlow:
    ...
    def test_complete_auth_flow(self, client):
        ...
        user_data = {"username": "flowtest", "email": "flowtest@example.com", "password": "testpassword123"}
    ...
    def test_login_after_registration(self, client):
        ...
        user_data = {"username": "immediate_login", "email": "immediate@example.com", "password": "password123"}
...
class TestAuthValidation:
    ...
    def test_username_length_validation(self, client):
        ...
        # Too short username
        short_data = {"username": "a", "email": "test@example.com", "password": "password123"}

        client.post("/auth/register", json=short_data)
        # Should validate username length (implementation dependent)

        # Too long username
        long_data = {"username": "a" * 100, "email": "test@example.com", "password": "password123"}

        client.post("/auth/register", json=long_data)
        # Should validate username length (implementation dependent)
    ...
    def test_password_strength_validation(self, client):
        ...
        client.post("/auth/register", json=weak_password_data)
        # Should validate password strength (implementation dependent)

    def test_email_format_validation(self, client):
        """Test email format validation"""
        invalid_emails = ["notanemail", "@example.com", "test@", "test..test@example.com", "test@.com"]

        for invalid_email in invalid_emails:
            data = {"username": "testuser", "email": invalid_email, "password": "password123"}
    ...
    def test_special_characters_in_username(self, client):
        ...
        special_chars_data = {"username": "test@user#123", "email": "test@example.com", "password": "password123"}

        client.post("/auth/register", json=special_chars_data)
...
class TestAuthSecurity:
    ...
    def test_password_not_returned_in_response(self, client):
        ...
        user_data = {"username": "securitytest", "email": "security@example.com", "password": "secretpassword"}
