...
class TestIntegration:
    ...
    def test_real_world_scenarios(self):
        ...
        scenarios = [
            {
                "input": "ニンテンドースイッチが充電できない",
                "expected_device": "Nintendo Switch"
            },
            {
                "input": "iPhone 13 Pro Max の修理",
                "expected_device": "iPhone"
            },
            {
                "input": "MacBook Air の画面交換",
                "expected_device": "MacBook"
            },
            {
                "input": "PS5コントローラーの不具合",
                "expected_device": "PlayStation 5"
            }
        ]
    ...
    def test_batch_processing(self):
        ...
        batch_inputs = [
            "スイッチ", "プレステ", "アイフォン", "ノートパソコン", "スマホ",
            "switch", "playstation", "iphone", "laptop", "smartphone"
        ] * 10  # 50 items total
