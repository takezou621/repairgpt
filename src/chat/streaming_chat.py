...
class StreamingRepairChatbot(RepairChatbot):
    ...
    async def stream_chat(self, user_message: str, include_context: bool = True) -> AsyncGenerator[StreamingResponse, None]:
    ...
    async def _stream_with_openai(self, user_message: str, include_context: bool) -> AsyncGenerator[StreamingResponse, None]:
    ...
    async def _stream_with_anthropic(self, user_message: str, include_context: bool) -> AsyncGenerator[StreamingResponse, None]:
...
class TokenUsageTracker:
    ...
    def log_usage(self, provider: str, model: str, input_tokens: int, output_tokens: int, cost: Optional[float] = None):
