...
"""
    ...
    def _enhanced_fallback_response(self, user_message: str) -> str:
        ...
        repair_knowledge = {
            "joy-con": {
                "drift": {
                    "symptoms": ["analog stick moves without input", "character moves randomly", "cursor drifts"],
                    "causes": ["worn analog stick mechanisms", "dust/debris buildup", "electrical contact issues"],
                    "solutions": [
                    ...
                    "tools": ["Compressed air", "Contact cleaner (optional)", "Y00 Tripoint screwdriver (for replacement)", "Plastic prying tools"],
            ...
            "iphone": {
                "screen": {
                    "symptoms": ["cracked display", "black screen", "touch not responding", "lines on screen"],
                    "causes": ["impact damage", "pressure damage", "liquid damage", "connector issues"],
                    "solutions": [
                    ...
                    "tools": ["Pentalobe screwdrivers", "Suction cups", "Heat gun/pads", "Spudgers", "Screen assembly"],
            ...
            "laptop": {
                "boot": {
                    "symptoms": ["won't turn on", "no display", "fan spins but no boot", "blue screen"],
                    "causes": ["power supply issues", "battery problems", "RAM issues", "hard drive failure", "motherboard problems"],
                    "solutions": [
                    ...
                    "tools": ["Screwdrivers", "Anti-static wrist strap", "External monitor", "Replacement RAM (for testing)"],
